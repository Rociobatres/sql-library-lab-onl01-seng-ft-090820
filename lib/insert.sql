...
INSERT INTO characters (id, name, motto, species, author_id) VALUES (1, "Sailor Moon", "In the power of the moon, I will punish you!", "Sailor Guardian", 2), (2, "Tuxedo Mask", "*throws a rose*", 2), (3, "Sailor Mars", "I'm Sailor Mars of the red heel!", "Sailor Guardian", 2), (4, "Chibiusa", "I am a graceful lady", "Pesky child", 2);
